...
def export_ips_docx(letter: Letter, iocs: list[IoC]) -> bytes:
...
def export_domains_docx(letter: Letter, iocs: list[IoC]) -> bytes:
...
def export_emails_docx(letter: Letter, iocs: list[IoC]) -> bytes:
...
def export_all_iocs_docx(letter: Letter, iocs: list[IoC]) -> bytes:
    doc = _create_doc()
...
EXPORT_DOCX_TYPES = {
    "emails": export_emails_docx,
    "ip_addresses": export_ips_docx,
    "domains": export_domains_docx,
    "ioc_indicators": export_all_iocs_docx,
}

EXPORT_DOCX_FILENAMES = {
    "emails": "emails.docx",
